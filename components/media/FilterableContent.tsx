      ...
      <div className="relative">
        ...
        >
          <button
            ...
            style={{
              background: activeGenres.length === 0 ? '#e50914' : 'rgba(255,255,255,0.05)',
              color: activeGenres.length === 0 ? '#fff' : 'rgba(255,255,255,0.5)',
              border: activeGenres.length === 0 ? '1px solid #e50914' : '1px solid rgba(255,255,255,0.12)',
              boxShadow: activeGenres.length === 0 ? '0 0 12px rgba(229,9,20,0.4)' : 'none',
            }}
            onMouseEnter={(e) => {
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: active ? '1px solid #e50914' : '1px solid rgba(255,255,255,0.12)',
                  boxShadow: active ? '0 0 12px rgba(229,9,20,0.4)' : 'none',
                }}
                onMouseEnter={(e) => {
                  if (!active) {
                    e.currentTarget.style.background = 'rgba(255,255,255,0.1)';
